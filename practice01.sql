...
-- 문제 9
SELECT first_name||' '||last_name "�̸�", salary "문제", phone_number "��ȭ-��ȣ", hire_date "�Ի���"
FROM employees
ORDER BY hire_date;
...
-- 문제 30
SELECT employee_id "���",first_name "�̸�",salary "문제", salary/12 "문제", salary/12*0.033 "문제", salary-salary/12*0.033 "�Ǽ��ɾ�"
FROM employees;
